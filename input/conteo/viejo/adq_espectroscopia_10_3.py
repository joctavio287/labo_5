...
tension_fuente = 2
carpeta = 'laser_2v'
os.mkdir(f'C:/GRUPO 8/poisson(10ms)/{carpeta}')
umbral =  0.0001
t_0 = time.time()
for i in range(numero_de_mediciones):
    ...
    fname = f'C:/GRUPO 8/poisson(10ms)/{carpeta}/medicion_{i}.pkl'
    
    tension_PMT, escala_v, escala_h, angulo_polarizador, resistencia = '900 V', '5 V', '10 ms', '20 º', '22k Ohms'
    medicion = {
...
# Ruido
tensiones_ruido = []
for i, f in enumerate(os.listdir('C:/GRUPO 8/poisson(10ms)/ruido_2v/')):
    medicion = load_dict(fname = 'C:/GRUPO 8/poisson(10ms)/ruido_2v/' + f)
...
for i, f in enumerate(os.listdir('C:/GRUPO 8/poisson(10ms)/ruido_oscuro_2v/')):
    medicion = load_dict(fname = 'C:/GRUPO 8/poisson(10ms)/ruido_oscuro_2v/' + f)
