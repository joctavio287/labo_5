...
fig.show()
# fig.savefig(fname = os.path.join(input_path + os.path.normpath('/medicion_sinrb.png')))
...
ax.grid(visible = True)
fig.show()
# fig.savefig(fname =os.path.join(input_path + os.path.normpath('/medicion_conrb.png')))
...
ax.grid(visible = True)
fig.show()
# fig.savefig(fname =os.path.join(input_path + os.path.normpath('/medicion_1200uA.png')))
...
ax.grid(visible = True)
fig.show()
# fig.savefig(fname =os.path.join(input_path + os.path.normpath('/absorcion_24_126C.png')))
